...
namespace CodeWalker.Forms
{
    public partial class ModelForm : Form, DXForm
    {
        ...
        {
            GameFileUtils.UpdateEmbeddedTextures(Ydr);
            GameFileUtils.UpdateEmbeddedTextures(Ydd);
            GameFileUtils.UpdateEmbeddedTextures(Ypt);
            GameFileUtils.UpdateEmbeddedTextures(Yft);
        }
